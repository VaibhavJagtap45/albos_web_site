        ...
        <div className="relative z-10 mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20 pt-28 md:pt-36 lg:pt-44 pb-12 md:pb-16">
          ...
          <nav aria-label="Breadcrumb" className="mb-8">
            <ol className="flex items-center gap-2 text-sm font-[family-name:var(--font-inter)] text-[#A1A1AA]">
              <li>
                <Link href="/" className="hover:text-[#F97316] transition-colors duration-200">
                  Home
                </Link>
              </li>
              <li aria-hidden="true">
              ...
              <li>
                <Link href="/blog" className="hover:text-[#F97316] transition-colors duration-200">
                  Blog
                </Link>
              </li>
              <li aria-hidden="true">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="mt-3 text-sm text-[#52525B] font-[family-name:var(--font-inter)] leading-relaxed">
                    Expert in {post.category.toLowerCase()} at Albos Technologies Pvt Ltd. Sharing insights from years of building enterprise solutions at scale.
                  </p>
