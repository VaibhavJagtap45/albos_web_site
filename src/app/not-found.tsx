...
function BrokenCircuit() {
  return (
    ...
    >
      ...
      {/* Circuit nodes */}
      <circle cx="30" cy="100" r="4" fill="white" stroke="#F97316" strokeWidth="1.5" />
      <circle cx="60" cy="40" r="3" fill="white" stroke="rgba(0,0,0,0.15)" strokeWidth="1" />
      <circle cx="140" cy="60" r="4" fill="white" stroke="#F97316" strokeWidth="1.5" />
      <circle cx="200" cy="60" r="3" fill="#F97316" opacity="0.6" />
      <circle cx="250" cy="140" r="3" fill="white" stroke="#F97316" strokeWidth="1.5" />
      <circle cx="270" cy="140" r="3" fill="white" stroke="rgba(0,0,0,0.15)" strokeWidth="1" />
      ...
      {/* Small IC/chip shape */}
      <rect x="80" y="80" width="20" height="16" rx="2" stroke="rgba(0,0,0,0.12)" strokeWidth="1" fill="none" />
      <line x1="85" y1="80" x2="85" y2="76" stroke="rgba(0,0,0,0.08)" strokeWidth="1" />
      <line x1="90" y1="80" x2="90" y2="76" stroke="rgba(0,0,0,0.08)" strokeWidth="1" />
      <line x1="95" y1="80" x2="95" y2="76" stroke="rgba(0,0,0,0.08)" strokeWidth="1" />
      <line x1="85" y1="96" x2="85" y2="100" stroke="rgba(0,0,0,0.08)" strokeWidth="1" />
      <line x1="90" y1="96" x2="90" y2="100" stroke="rgba(0,0,0,0.08)" strokeWidth="1" />
      <line x1="95" y1="96" x2="95" y2="100" stroke="rgba(0,0,0,0.08)" strokeWidth="1" />
    </svg>
  );
}
