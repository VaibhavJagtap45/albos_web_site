...
import { ArrowRight, ArrowUp, Mail, MapPin, Phone, Send, Loader2, Check, AlertCircle, Sparkles, Shield, Zap, Calendar, FileText, Briefcase, Rocket } from 'lucide-react';
import { SERVICES, CONTACT_INFO, CASE_STUDIES, CLIENT_LOGOS } from '@/lib/constants';
...
export function Footer({ onNavigate }: FooterProps) {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#050505]">
      ...
      <div className="absolute top-20 right-12 size-1.5 rounded-full bg-[#F97316]/15 animate-float pointer-events-none" style={{ animationDelay: '1s' }} />
      <div className="absolute bottom-24 left-16 size-1 rounded-full bg-[#F97316]/10 animate-float pointer-events-none" style={{ animationDelay: '2s' }} />
      <div className="absolute bottom-16 right-20 size-2.5 rounded-full bg-[#F97316]/15 animate-float pointer-events-none" style={{ animationDelay: '3s' }} />
      ...
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10 pt-12 pb-8 lg:pt-16 lg:pb-10">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-3 font-[family-name:var(--font-plus-jakarta)] text-sm font-semibold text-[#F5F4F0]/80 tracking-wide uppercase">
              Full-Stack Software Engineering
            </p>
            <p className="mt-3 text-sm leading-relaxed text-[#A1A1AA] max-w-xs">
              Full-stack software engineering company based in Pune, India. 500+ digital products shipped for startups and enterprises across 12 industries — from MVPs to complex enterprise platforms.
            </p>
            ...
            <div className="mt-6 rounded-xl border border-white/[0.06] bg-[#0F0F0F] p-5 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-xs text-[#A1A1AA] mb-3">
                  Get exclusive insights on enterprise tech, engineering culture, and industry trends.
                </p>
                ...
                <div className="flex items-center gap-1.5 mb-4">
                  <div className="flex -space-x-1.5">
                    {[0,1,2].map((i) => (
                      <div key={i} className="size-5 rounded-full bg-[#1A1A1A] border border-white/[0.1] flex items-center justify-center">
                ...
                <form onSubmit={handleSubscribe} className="flex gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      style={{
                        borderColor: inputFocused ? 'rgba(249, 115, 22, 0.5)' : 'rgba(255, 255, 255, 0.08)',
                        boxShadow: inputFocused ? '0 0 0 3px rgba(249, 115, 22, 0.1), 0 0 15px rgba(249, 115, 22, 0.05)' : 'none',
                      }}
                    />
                  </div>
                  <button
              ...
              <div className="space-y-3 pt-2">
                {CONTACT_INFO.offices.map((office) => (
                  ...
                  >
                    ...
                    <div>
                      <span className="text-[#F5F4F0]/80 font-medium">{office.city}</span>
                      <br />
        ...
        <div className="mt-14 pt-8 border-t border-white/[0.06]">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-6">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="text-xs text-[#A1A1AA] transition-colors duration-300 hover:text-[#F97316] cursor-default"
                >
                  Privacy Policy
                </button>
            ...
            <div className="flex items-center gap-5">
              <a href={CONTACT_INFO.social.linkedin} target="_blank" rel="noopener noreferrer" className="magnetic-hover text-[#A1A1AA] transition-all duration-300 hover:text-[#F97316]" aria-label="LinkedIn">
                <svg className="size-[18px]" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
              </a>
              <a href={CONTACT_INFO.social.twitter} target="_blank" rel="noopener noreferrer" className="magnetic-hover text-[#A1A1AA] transition-all duration-300 hover:text-[#F97316]" aria-label="Twitter / X">
              ...
              <a href={CONTACT_INFO.social.github} target="_blank" rel="noopener noreferrer" className="magnetic-hover text-[#A1A1AA] transition-all duration-300 hover:text-[#F97316]" aria-label="GitHub">
              ...
              <a href={CONTACT_INFO.social.dribbble} target="_blank" rel="noopener noreferrer" className="magnetic-hover text-[#A1A1AA] transition-all duration-300 hover:text-[#F97316]" aria-label="Dribbble">
            ...
            {/* Made with love */}
            <p className="font-[family-name:var(--font-inter)] text-xs text-[#A1A1AA]/60">
              Made with <span className="text-[#F97316]">&#10084;</span> in Pune, India
            </p>
          </div>
        </div>
      </div>
