          ...
          >
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="mt-6 rounded-xl bg-[#FAFAFA] border border-black/[0.06] p-5">
                <span className="font-[family-name:var(--font-inter)] text-xs uppercase tracking-wider text-[#A1A1AA]">Key Result</span>
                ...
                <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {study.duration && (
                    <div className="rounded-lg border border-black/[0.06] bg-black/[0.02] p-4">
                      <span className="font-[family-name:var(--font-inter)] text-[10px] uppercase tracking-wider text-[#A1A1AA]">Duration</span>
                      <p className="mt-1 font-[family-name:var(--font-plus-jakarta)] text-sm font-bold text-[#18181B]">{study.duration}</p>
                    </div>
                  )}
                  {study.team && (
                    <div className="rounded-lg border border-black/[0.06] bg-black/[0.02] p-4">
                      <span className="font-[family-name:var(--font-inter)] text-[10px] uppercase tracking-wider text-[#A1A1AA]">Team Size</span>
                      <p className="mt-1 font-[family-name:var(--font-plus-jakarta)] text-sm font-bold text-[#18181B]">{study.team}</p>
                    </div>
                  )}
                  {study.tech && study.tech.length > 0 && (
                    <div className="rounded-lg border border-black/[0.06] bg-black/[0.02] p-4 sm:col-span-3">
                      <span className="font-[family-name:var(--font-inter)] text-[10px] uppercase tracking-wider text-[#A1A1AA]">Technology Stack</span>
                      <div className="mt-2 flex flex-wrap gap-2">
                        {study.tech.map((t) => (
                          <span key={t} className="inline-flex items-center gap-1 rounded-md bg-[#F97316]/10 border border-[#F97316]/20 px-2.5 py-1 text-[11px] font-medium text-[#F97316] font-[family-name:var(--font-jetbrains-mono)]">
                            {t}
                          </span>
                        ))}
                      </div>
