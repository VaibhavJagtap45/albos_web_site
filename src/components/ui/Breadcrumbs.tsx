...
export function Breadcrumbs({ items, onNavigate }: BreadcrumbsProps) {
  ...
  const allItems: BreadcrumbItem[] = [{ label: 'Home', page: 'home' }, ...items];
  ...
  return (
    ...
    >
      <ol className="flex items-center gap-1.5 text-sm flex-wrap" style={{ fontFamily: 'var(--font-inter), system-ui, sans-serif' }}>
            ...
            >
              ...
              {isLast ? (
                ...
                >
                  ...
                  <span className="hidden sm:inline font-[family-name:var(--font-plus-jakarta)] text-sm font-medium">Home</span>
                </button>
              ) : (
