...
.highlight-rail {
height:3px;
background:linear-gradient(90deg,#1d4ed8,#3b82f6,#0d9488);
...
`}</style>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden grid-bg">
        ...
        <div className="relative z-10 max-w-screen-2xl mx-[20px] px-4 md:px-12 py-28 grid md:grid-cols-2 gap-16 items-center w-full">
