    ...
    <>
      ...
      <main className="erp-root" style={{ minHeight: "100vh" }}>
        ...
        <section style={{ position: "relative", padding: "80px 24px 72px", overflow: "hidden" }}>
          {/* blobs */}
          <div className="blob" style={{ width: 420, height: 420, background: "rgba(29,78,216,.07)", top: -80, right: -80, animationDelay: "0s" }} />
...
`}</style>
            ...
            <h1 style={{
              ...
              {[ "CRM", "Systems"].map((w, i) => (
                <React.Fragment key={i}>
                  {i === 0
                    ? <span className="hero-word grad-text animated-underline " style={{ animationDelay: `${.35 + i * .11}s` }}>{w}</span>
                    : <span className="hero-word grad-text" style={{ animationDelay: `${.35 + i * .11}s` }}>{w}</span>
                  }
                  {i < 3 ? " " : ""}
                </React.Fragment>
              ))}
        ...
        <section style={{ padding: "0 24px", background: "white" }}>
          <div style={{ maxWidth: 1380, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", borderLeft: "1px solid var(--line)" }}>
            {[
        ...
        <section ref={ctaRef} className="reveal" style={{ padding: "0 24px 80px" }}>
          <div style={{ maxWidth: 1380, margin: "0 auto" }}>
            <div style={{
              ...
              <div className="blob" style={{ width: 300, height: 300, background: "rgba(29,78,216,.2)", top: -80, right: -40, animationDelay: "1s" }} />
