...
import { ArrowRight, Check, X, Users, FolderKanban, UserPlus, Clock, Code2, Rocket, BarChart3, Zap, TrendingUp, Shield, Star } from 'lucide-react';
...
const ENGAGEMENT_MODELS = [
  {
    ...
    description: 'A fully integrated team of engineers, designers, and PMs working exclusively on your project. Think of them as your own in-house team, without the overhead.',
    pros: ['Full control & flexibility', 'Deep domain knowledge', 'Long-term consistency', 'Scalable on demand'],
  ...
  },
  {
    icon: FolderKanban,
    title: 'Project-Based',
    description: 'Fixed scope, fixed timeline, fixed budget. We take ownership of the entire delivery — from design through deployment — with full transparency at every stage.',
    pros: ['Predictable costs', 'Clear milestones', 'End-to-end ownership', 'Risk mitigation'],
  ...
  },
  {
    ...
    description: 'Need specific expertise fast? We embed senior engineers into your existing team to fill skill gaps and accelerate delivery without the hiring cycle.',
    pros: ['Rapid onboarding (1-2 weeks)', 'No long-term commitment', 'Specific skill sets', 'Seamless integration'],
...
const COMPARISON_FEATURES = [
  {
    ...
    values: ['8–16 weeks', '6–12 weeks', '8–14 weeks', '10–20 weeks', '4–8 weeks', '4–10 weeks'],
  },
  {
    row: 'Team Size',
  ...
  {
    row: 'Best For',
    values: ['Enterprise Systems', 'Digital Platforms', 'Mobile-First Products', 'AI-Powered Solutions', 'Infrastructure & Scaling', 'Product Design'],
  },
  {
    row: 'Price Range',
    values: ['$75K–$500K', '$50K–$300K', '$60K–$350K', '$80K–$400K', '$40K–$200K', '$30K–$150K'],
  },
  {
  ...
  return (
    <section className="relative mesh-gradient-1 overflow-hidden">
      ...
      <div className="relative flex min-h-[50vh] flex-col justify-center px-6 md:px-12 lg:px-20 pt-32 pb-16 md:pt-40 md:pb-20">
        ...
        <div className="absolute top-20 right-16 w-16 h-16 rounded-full border border-[#F97316]/10 animate-float pointer-events-none hidden lg:block" style={{ animationDelay: '0s' }} />
        <div className="absolute bottom-32 right-32 w-3 h-3 rounded-full bg-[#F97316]/20 animate-float pointer-events-none hidden lg:block" style={{ animationDelay: '2s' }} />
        <div className="absolute top-1/2 right-1/4 w-24 h-24 rounded-full border border-[#F97316]/5 animate-float pointer-events-none hidden lg:block" style={{ animationDelay: '4s' }} />
        ...
        <div className="relative z-10 mx-auto max-w-[var(--container-max)] w-full flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="flex-1">
            ...
            <ScrollReveal direction="up" delay={0.1}>
              ...
              >
                End-to-End<br />Software Engineering
              </h1>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.2}>
              <p className="mt-6 text-[#A1A1AA] text-base md:text-lg max-w-2xl font-[family-name:var(--font-inter)] leading-relaxed">
                From concept to scale — we architect, design, build, and maintain enterprise software that drives measurable business outcomes across every industry.
              </p>
            </ScrollReveal>
          </div>
      ...
      {/* ═══ STICKY TAB BAR ═══ */}
      <div className="sticky top-0 z-30 bg-[#FAFAFA]/90 backdrop-blur-xl border-b border-black/[0.06]">
          ...
          return (
            ...
            >
              <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20 py-20 md:py-28">
                <div className={`flex flex-col ${isOdd ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-8 lg:gap-16 items-stretch`}>
                  {/* Content Column */}
                        ...
                        {service.techStack.map((tech) => (
                          <div key={tech} className="flex items-center gap-1.5">
                            <span
                              ...
                              style={{ backgroundColor: TECH_COLORS[tech] || '#F97316' }}
                            />
                  ...
                  <ScrollReveal direction={isOdd ? 'right' : 'left'} delay={0.15} className="w-full lg:w-[60%]">
                    <ParallaxPanel imageSrc={SERVICE_IMAGES[i] || SERVICE_IMAGES[0]} gradient={SERVICE_GRADIENTS[i] || SERVICE_GRADIENTS[0]} serviceId={service.id} serviceTitle={service.title} techStack={service.techStack} />
                  </ScrollReveal>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20">
          ...
          <div className="relative ml-4 md:ml-8">
            {PROCESS_STEPS.map((step, i) => (
              <TimelineStep key={step.number} step={step} index={i} isLast={i === PROCESS_STEPS.length - 1} />
            ))}
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20">
          <ScrollReveal direction="up" className="mb-12 lg:mb-16">
            ...
            <p className="mt-4 text-[#A1A1AA] text-base md:text-lg max-w-2xl font-[family-name:var(--font-inter)]">
              Flexible engagement options designed to match your project scope, timeline, and budget.
            </p>
          </ScrollReveal>
      ...
      <div className="relative bg-[#FAFAFA] py-20 md:py-28 lg:py-36">
        ...
        <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20">
          <ScrollReveal direction="up" className="mb-12 lg:mb-16">
            ...
            <p className="mt-4 text-[#A1A1AA] text-base md:text-lg max-w-2xl font-[family-name:var(--font-inter)]">
              Side-by-side comparison to help you find the right fit for your project needs.
            </p>
          </ScrollReveal>
...
function ParallaxPanel({
  ...
  return (
    <div ref={ref} className="relative w-full">
      <div
        className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden border-glow group"
      >
        {/* Service Image */}
...
function ServicesComparisonTable({ activeService }: { activeService: number }) {
        ...
        <div className="min-w-[900px]">
                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  <span
                    className={`text-[11px] font-semibold font-[family-name:var(--font-inter)] text-center leading-tight transition-colors duration-300 ${
                      activeService === i ? 'text-[#F97316]' : 'text-[#18181B]/80'
                    }`}
                  >
                    {service.title}
                  </span>
          ...
          {COMPARISON_FEATURES.map((feature, rowIdx) => (
            ...
            >
              ...
              <div
                className="sticky left-0 z-10 px-5 py-3.5 border-b border-r border-black/[0.06] flex items-center bg-inherit"
              >
                ...
                return (
                  <div
                    ...
                    className={`px-4 py-3.5 border-b border-r border-black/[0.06] last:border-r-0 flex items-center justify-center transition-all duration-300 ${
                      isActive ? 'bg-[#F97316]/[0.06]' : isHovered ? 'bg-black/[0.02]' : ''
                    }`}
                  ...
                  >
                    {isBool ? (
                      ...
                      <span className={`text-xs font-semibold font-[family-name:var(--font-inter)] text-center transition-colors duration-300 ${
        ...
        <ScrollReveal direction="right" delay={index * 0.08}>
          ...
          <ul className="mt-4 space-y-2">
            {step.deliverables.map((item) => (
              <li key={item} className="flex items-center gap-2.5 text-sm text-[#18181B]/70 font-[family-name:var(--font-inter)]">
...
function EngagementCard({ model }: { model: (typeof ENGAGEMENT_MODELS)[number] }) {
  ...
  return (
    ...
    >
      ...
      <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl mb-5 ${
        ...
        <Icon className={`h-6 w-6 ${model.recommended ? 'text-[#F97316]' : 'text-[#A1A1AA]'}`} />
      </div>
      ...
      <ul className="mt-5 space-y-2">
        {model.pros.map((pro) => (
          <li key={pro} className="flex items-center gap-2 text-sm text-[#18181B]/80 font-[family-name:var(--font-inter)]">
