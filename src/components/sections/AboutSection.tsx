...
import { STATS, TEAM_MEMBERS, COMPANY_VALUES } from '@/lib/constants';
import { SectionLabel } from '@/components/ui/SectionLabel';
import { ScrollReveal } from '@/components/ui/ScrollReveal';
import { CountUp } from '@/components/ui/CountUp';
import { MagneticButton } from '@/components/ui/MagneticButton';
import { fadeUp, staggerContainer, revealMask } from '@/lib/animations';
...
/* ─── Timeline milestones ─── */
const MILESTONES = [
  { year: '2014', event: 'Founded', description: 'Albos Technologies Pvt Ltd launched in Pune, India with a mission to deliver world-class software engineering services.' },
  { year: '2016', event: '100th Project', description: 'Milestone reached — 100 successful project deliveries across FinTech, HealthTech, and EdTech.' },
  { year: '2019', event: 'Global Reach', description: 'Clients across 12 industries worldwide. Team grows to 150+ engineers delivering enterprise-grade solutions.' },
  { year: '2022', event: 'AI & Blockchain', description: 'Launched dedicated AI/ML and Blockchain practices. Expanded service portfolio to 9 core verticals.' },
  { year: '2024', event: '500+ Projects', description: '250+ professionals, 500+ projects delivered, 320+ happy clients. 4.9★ Clutch rating. ISO Certified.' },
];
...
const LEADER_QUOTES: Record<string, string> = {
  'Alex Volkov': 'Great software is built by people who refuse to settle for "good enough."',
  'Maria Santos': 'The best architecture is invisible — it just lets the business move faster.',
  ...
  'Ahmed Hassan': 'Security and performance are not features — they are foundations.',
  'Lisa Wang': 'AI should amplify human capability, not replace human judgment.',
  "James O'Brien": 'Every client partnership begins with listening, not selling.',
  'Priya Patel': 'Quality is never an accident — it is always the result of intelligent effort.',
};
...
const BENEFITS = [
  {
    ...
    description: 'Work from anywhere with flexible hours. We trust our team to deliver regardless of location.',
  },
  {
    icon: GraduationCap,
    title: 'Learning Budget',
    description: '$5,000 annual budget for courses, conferences, and certifications to keep you growing.',
  },
  {
    icon: Heart,
  ...
  },
  {
    ...
    description: 'Monthly gym membership reimbursement and wellness program access.',
  },
  {
    icon: Plane,
    title: 'Unlimited PTO',
    description: 'Take the time you need to recharge. We measure output, not hours at a desk.',
  },
  {
    icon: Coffee,
    title: 'Team Retreats',
    description: 'Annual company retreats and quarterly team offsites to build connection.',
  },
];
        ...
        <div className="relative z-10 mx-auto max-w-[var(--container-max)] w-full flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="flex-1">
            ...
            <ScrollReveal direction="up" delay={0.1}>
              ...
              >
                Built by Engineers.<br />Driven by Results.
              </h1>
            </ScrollReveal>
            <ScrollReveal direction="up" delay={0.2}>
              <p className="mt-6 text-[#A1A1AA] text-base md:text-lg max-w-2xl font-[family-name:var(--font-inter)] leading-relaxed">
                We are a team of 250+ engineers, designers, and strategists based in Pune, India who believe that great software is built by people who genuinely care about the outcome.
              </p>
            </ScrollReveal>
          </div>
      ...
      <div className="relative bg-[#FAFAFA] py-24 md:py-32 lg:py-40">
        ...
        <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              &ldquo;We exist to turn your most complex technical challenges into your{' '}
              <span className="text-[#F97316] font-medium not-italic">greatest competitive advantages</span>.&rdquo;
            </motion.blockquote>
          ...
          >
            <div className="flex gap-0 min-w-max">
              {MILESTONES.map((milestone, i) => (
                <TimelineMilestone key={milestone.year} milestone={milestone} index={i} isLast={i === MILESTONES.length - 1} />
              ))}
            </div>
          </div>
        </div>
              ...
              <ScrollReveal key={stat.label} direction="up" delay={i * 0.1}>
                <div
                  className={`relative flex flex-col items-center text-center px-6 py-4 glow-accent ${
                    i < STATS.length - 1 ? 'sm:border-r sm:border-black/[0.06] lg:border-r lg:border-black/[0.06]' : ''
                  } ${
                    i < 2 ? 'border-b sm:border-b-0 border-black/[0.06] lg:border-b-0' : ''
                  }`}
                >
        ...
        <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20">
          <ScrollReveal direction="up" className="mb-12 lg:mb-16">
            ...
            <p className="mt-4 text-[#A1A1AA] text-base md:text-lg max-w-2xl font-[family-name:var(--font-inter)] leading-relaxed">
              Headquartered in Pune, India with global reach across 12 industries. We deliver excellence for clients worldwide.
            </p>
          </ScrollReveal>
            ...
            {TEAM_MEMBERS.map((member, i) => (
              <ScrollReveal key={member.name} direction="up" delay={i * 0.06}>
                <LeadershipCard
                  ...
                  quote={LEADER_QUOTES[member.name] ?? ''}
                />
              </ScrollReveal>
            ))}
          </div>
      ...
      <div className="relative bg-[#FAFAFA] py-20 md:py-28 lg:py-36">
        ...
        <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20">
          <ScrollReveal direction="up" className="mb-12 lg:mb-16">
            ...
            <p className="mt-4 text-[#A1A1AA] text-base md:text-lg max-w-2xl font-[family-name:var(--font-inter)] leading-relaxed">
              We invest in our people because extraordinary outcomes require extraordinary teams.
            </p>
          </ScrollReveal>
        ...
        <div className="relative z-10 mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20 text-center">
          <ScrollReveal direction="up">
            ...
            <p className="mt-6 text-[#A1A1AA] text-base md:text-lg max-w-xl mx-auto font-[family-name:var(--font-inter)] leading-relaxed">
              Build the future of enterprise software alongside world-class engineers, designers, and product thinkers.
            </p>
...
function TimelineMilestone({
  ...
  return (
    <div ref={ref} className="relative flex flex-col items-center px-8 md:px-12 lg:px-16">
      ...
      {!isLast && (
        <div className="absolute top-[calc(50%+8px)] left-[calc(50%+32px)] right-0 h-[2px] hidden md:block">
          <div
            ...
            style={{
              backgroundImage: 'repeating-linear-gradient(90deg, #F97316 0px, #F97316 4px, transparent 4px, transparent 10px)',
              opacity: 0.3,
            }}
          />
        </div>
      ...
      <motion.h3
        ...
        transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1], delay: index * 0.1 + 0.3 }}
      >
        {milestone.event}
      </motion.h3>
      ...
      <motion.p
        ...
        initial={{ opacity: 0, y: 10 }}
        animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 10 }}
        transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1], delay: index * 0.1 + 0.4 }}
      >
...
function WorldMap() {
  ...
  return (
    <div ref={ref} className="relative w-full aspect-[2/1] max-h-[500px] rounded-2xl border border-black/[0.06] bg-[#FAFAFA] overflow-hidden">
      ...
      >
        ...
        {OFFICES.map((office, i) => (
          <g key={office.city}>
            ...
            <motion.circle
              ...
              transition={{ duration: 0.4, delay: 0.6 + i * 0.12, ease: [0.16, 1, 0.3, 1] }}
            />
            {/* Glow */}
            <motion.circle
              cx={office.x}
        ...
        {OFFICES.map((office, i) => (
          <motion.g
            ...
            transition={{ duration: 0.5, delay: 1 + i * 0.12, ease: [0.16, 1, 0.3, 1] }}
          >
            <text
              x={office.x}
              y={office.y - 2.5}
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(180deg, transparent 40%, rgba(249,115,22,0.08) 100%)',
          }}
...
function ValueCard({
  ...
  value: (typeof COMPANY_VALUES)[number];
  index: number;
}) {
  ...
  return (
    ...
    >
      ...
      <div className="relative p-6 md:p-8">
        ...
        >
          <Icon className={`h-5 w-5 ${isEven ? 'text-[#F97316]' : 'text-[#A1A1AA]'} group-hover:text-[#F97316] transition-colors duration-300`} />
        </motion.div>
        ...
        >
          <div className="pt-4 mt-4 border-t border-black/[0.06]">
            <p className="text-[#71717A] text-sm font-[family-name:var(--font-inter)] leading-relaxed">
              This value shapes everything we do — from how we hire and onboard new team members to how we approach code reviews and client communication.
            </p>
          </div>
        </motion.div>
      </div>
