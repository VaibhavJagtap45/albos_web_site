...
export function HeroSection({ onNavigate }: HeroSectionProps) {
  ...
  return (
    <section className="relative flex h-[100svh] items-center justify-center overflow-hidden bg-[#FAFAFA]">
      ...
      <div className="absolute inset-0 z-[3] pointer-events-none opacity-[0.15]"
        style={{
      ...
      <div className="relative z-10 flex h-full w-full flex-col justify-between px-6 py-8 md:px-12 lg:px-20">
        ...
        <div className="flex flex-1 flex-col items-center justify-center text-center -mt-4 md:-mt-12">
          ...
          >
            ...
            >
              <h1
                className="hero-display-heading whitespace-nowrap font-[family-name:var(--font-plus-jakarta)] font-extrabold text-[#18181B]"
              >
            ...
            {/* Stat pill */}
            <motion.div variants={fadeUp} className="mt-6 sm:mt-8 md:mt-10 flex justify-center px-4">
        ...
        >
          ...
          <ScrollReveal direction="right" delay={1.2}>
            <button onClick={() => setIsVideoOpen(true)} aria-label="Watch showreel video" className="group flex items-center gap-2 sm:gap-3 border border-black/[0.12] rounded-full px-3 sm:px-5 py-2 sm:py-3 transition-all duration-300 hover:border-black/[0.25] hover:bg-black/[0.04]">
              ...
              <MagneticButton strength={0.25}>
                ...
                >
                  ...
                  >
                    ...
                    <text className="fill-white/60" fontSize="7.5" fontWeight="600" letterSpacing="3">
      ...
      <div className="absolute bottom-1/3 right-[15%] w-32 h-32 border border-black/[0.03] rounded-full animate-float" style={{ animationDelay: '2s' }} />
      <div className="absolute top-1/2 right-[8%] w-2 h-2 bg-[#F97316]/30 rounded-full animate-float" style={{ animationDelay: '4s' }} />
      <div className="absolute top-[30%] left-[20%] w-1.5 h-1.5 bg-[#F97316]/20 rounded-full animate-float" style={{ animationDelay: '1s' }} />
