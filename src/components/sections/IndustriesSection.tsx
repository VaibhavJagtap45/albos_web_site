...
const INDUSTRY_DETAILS = [
  {
    ...
    features: [
      { icon: ShieldCheck, name: 'HIPAA Compliance', desc: 'End-to-end encrypted data handling with audit trails' },
      { icon: Activity, name: 'Real-Time Monitoring', desc: 'Live patient vitals dashboards and alerting systems' },
      { icon: Globe, name: 'Telehealth Platforms', desc: 'Secure video consultations and remote diagnostics' },
    ],
  ...
  },
  {
    ...
    features: [
      { icon: LockKeyhole, name: 'Fraud Detection', desc: 'ML-powered real-time transaction anomaly detection' },
      { icon: BarChart3, name: 'Risk Analytics', desc: 'Predictive modeling for credit and market risk' },
      { icon: Zap, name: 'Payment Infrastructure', desc: 'High-throughput payment processing and settlement' },
    ],
  ...
  },
  {
    ...
    features: [
      { icon: Cpu, name: 'Adaptive Learning', desc: 'AI-driven personalized learning paths and assessments' },
      { icon: Globe, name: 'Accessibility First', desc: 'WCAG 2.1 AA compliant interfaces and interactions' },
      { icon: BarChart3, name: 'Learning Analytics', desc: 'Real-time dashboards for student progress and outcomes' },
    ],
  ...
  },
  {
    ...
    features: [
      { icon: Database, name: 'Inventory Sync', desc: 'Real-time stock visibility across all channels' },
      { icon: Cpu, name: 'Personalization Engine', desc: 'AI-powered product recommendations and merchandising' },
      { icon: Globe, name: 'Omnichannel Platform', desc: 'Unified experience across web, mobile, and POS' },
    ],
  ...
  },
  {
    ...
    features: [
      { icon: Cpu, name: 'Predictive Maintenance', desc: 'IoT-driven equipment health monitoring and alerts' },
      { icon: Activity, name: 'Quality Automation', desc: 'Computer vision for real-time defect detection' },
      { icon: BarChart3, name: 'Production Optimization', desc: 'AI scheduling and throughput maximization' },
    ],
  ...
  },
  {
    ...
    features: [
      { icon: Globe, name: 'Fleet Visibility', desc: 'Real-time GPS tracking and geofencing alerts' },
      { icon: Cpu, name: 'Route Optimization', desc: 'AI-driven dynamic routing and load planning' },
      { icon: Database, name: 'Supply Chain Analytics', desc: 'End-to-end pipeline visibility and forecasting' },
    ],
  ...
  },
  {
    ...
    features: [
      { icon: Globe, name: 'Virtual Tours', desc: 'Immersive 3D property walkthroughs and staging' },
      { icon: Database, name: 'Property Management', desc: 'Unified listings, leases, and maintenance tracking' },
      { icon: BarChart3, name: 'Market Analytics', desc: 'Predictive valuation and investment insights' },
    ],
  ...
  },
  {
    ...
    features: [
      { icon: Database, name: 'Content Management', desc: 'Scalable DAM with automated tagging and rights' },
      { icon: Zap, name: 'Adaptive Streaming', desc: 'Multi-format delivery optimized per device and bandwidth' },
      { icon: BarChart3, name: 'Audience Analytics', desc: 'Real-time engagement metrics and monetization insights' },
    ],
...
export function IndustriesSection() {
  ...
  const [filterPill, setFilterPill] = useState<string | null>(null);
  const sectionRefs = useRef<(HTMLDivElement | null)[]>([]);
  const isClickScrolling = useRef(false);
  const sidebarRef = useRef<HTMLDivElement>(null);

  /* ─── Scroll to industry section ─── */
  const scrollToIndustry = useCallback((index: number) => {
  ...
  return (
    <section id="industries" className="relative overflow-hidden mesh-gradient-1">
      {/* ═══ HERO ═══ */}
      <div className="relative bg-[#FAFAFA] min-h-[60vh] flex flex-col justify-center px-6 md:px-12 lg:px-20 pt-32 pb-16 md:pt-40 md:pb-24">
        ...
        <div className="relative z-10 mx-auto max-w-[var(--container-max)] w-full">
          ...
          <ScrollReveal direction="up" delay={0.1}>
            ...
            >
              Software Solutions<br />Built for Your Industry
            </h1>
          </ScrollReveal>
          <ScrollReveal direction="up" delay={0.2}>
            <p className="mt-6 text-[#A1A1AA] text-base md:text-lg max-w-2xl font-[family-name:var(--font-inter)] leading-relaxed">
              Deep domain expertise meets world-class engineering. We deliver tailored software solutions that address the unique challenges and compliance requirements of your sector.
            </p>
          </ScrollReveal>
              ...
              {INDUSTRIES.map((industry) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    const idx = INDUSTRIES.findIndex((ind) => ind.name === industry.name);
              ...
              {INDUSTRIES.map((industry, i) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      background: activeIndustry === i ? 'rgba(255,255,255,0.04)' : 'transparent',
                    }}
                  >
              ...
              >
                ...
                <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20 py-20 md:py-28">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
                    ...
                    <div>
                      {/* Challenge Box */}
                      <ScrollReveal direction={isOdd ? 'left' : 'right'} delay={0.1}>
                        <div
                        ...
                        >
                          <span
                            className={`font-[family-name:var(--font-inter)] text-xs uppercase tracking-[0.15em] font-semibold ${
                              'text-[#F97316]'
                            }`}
                          >
                            The Challenge
                          ...
                          <p
                            className={`mt-3 text-sm md:text-base font-[family-name:var(--font-inter)] leading-relaxed ${
                              'text-[#52525B]'
                            }`}
                          >
                            {detail.challenge}
                      ...
                      {/* Solution */}
                      <ScrollReveal direction={isOdd ? 'left' : 'right'} delay={0.2}>
                        <div className="mt-8">
                          <span
                            className={`font-[family-name:var(--font-inter)] text-xs uppercase tracking-[0.15em] font-semibold ${
                              'text-[#18181B]'
                      ...
                      {/* Stat */}
                      <ScrollReveal direction={isOdd ? 'left' : 'right'} delay={0.3}>
                        <div className="mt-10">
                          <span
                            className={`font-[family-name:var(--font-inter)] text-xs uppercase tracking-[0.15em] font-semibold ${
                              'text-[#A1A1AA]'
                          ...
                          <div className="mt-2 flex items-baseline gap-2">
                            <span className="font-[family-name:var(--font-plus-jakarta)] text-5xl md:text-6xl font-extrabold text-[#F97316]">
                              <CountUp value={detail.stat.value} suffix={detail.stat.suffix} duration={2} />
                            </span>
                          </div>
                          <p
                            className={`mt-1 text-sm font-[family-name:var(--font-inter)] ${
                              'text-[#A1A1AA]'
                            }`}
                          >
                            {detail.stat.label}
                          ...
                          >
                            ...
                            >
                              <div className="flex items-start gap-4">
                                ...
                                <div>
                                  <h3
                                    className={`font-[family-name:var(--font-plus-jakarta)] text-lg font-bold leading-tight ${
                                      'text-[#18181B]'
                                    }`}
                                  >
                                    {feature.name}
                                  ...
                                  <p
                                    className={`mt-1.5 text-sm font-[family-name:var(--font-inter)] leading-relaxed ${
                                      'text-[#52525B]'
                                    }`}
                                  >
                                    {feature.desc}
        ...
        <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20">
          <ScrollReveal direction="up" className="mb-12 lg:mb-16">
            ...
            <p className="mt-4 text-[#A1A1AA] text-base md:text-lg max-w-2xl font-[family-name:var(--font-inter)] leading-relaxed">
              Year-over-year digital transformation investment growth across the sectors we serve.
            </p>
          </ScrollReveal>
      ...
      <div className="relative bg-[#FFFFFF] py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative">
          ...
          <div className="flex overflow-hidden">
            ...
            >
              {[...CLIENT_LOGOS.slice().reverse(), ...CLIENT_LOGOS.slice().reverse()].map((logo, i) => (
                <div
                  key={`row2-${i}`}
                  className="group flex items-center justify-center px-8 py-4 rounded-xl border border-black/[0.04] bg-black/[0.02] min-w-[180px] hover:border-[#F97316]/20 hover:bg-black/[0.04] transition-all duration-300 cursor-pointer grayscale hover:grayscale-0"
                >
      ...
      <div className="relative bg-[#F97316] py-20 md:py-28 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20 text-center">
          <ScrollReveal direction="up">
            <SectionLabel label="Core Capabilities" dark className="justify-center [&>span]:text-white/70 [&>span_span]:bg-white/50 [&>span_span:nth-child(2)]:bg-white" />
          </ScrollReveal>
          <ScrollReveal direction="up" delay={0.1}>
            <h2
      ...
      <div className="relative bg-[#FAFAFA] py-20 md:py-28">
        ...
        <div className="mx-auto max-w-[var(--container-max)] px-6 md:px-12 lg:px-20">
          ...
          <ScrollReveal direction="up" delay={0.1}>
            ...
            <p className="mt-4 text-[#A1A1AA] text-base md:text-lg max-w-2xl font-[family-name:var(--font-inter)] leading-relaxed">
              Our processes and infrastructure meet the highest industry standards, ensuring your data and operations are always protected.
            </p>
          </ScrollReveal>
      ...
      <div className="relative overflow-hidden py-20 md:py-28">
        ...
        <motion.div
          ...
          animate={{ y: [-15, 15, -15], x: [-5, 5, -5], opacity: [0.1, 0.3, 0.1] }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <ScrollReveal direction="left">
              ...
              <p className="mt-4 text-white/70 text-base md:text-lg max-w-lg font-[family-name:var(--font-inter)] leading-relaxed">
                Tell us about your industry challenge, and our solutions architects will map out the right approach — no commitment, no jargon.
              </p>
...
function IndustryBar({
  ...
  item: (typeof INDUSTRY_GROWTH)[number];
  index: number;
}) {
